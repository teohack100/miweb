...
-- Proyecto: programm_tienda
-- =============================================
-- Ejecutar en Adminer con la BD programm_tienda
...
CREATE TABLE IF NOT EXISTS cuentas (
    ...
    precio_pro           DECIMAL(10,2)     NULL DEFAULT NULL  COMMENT 'Precio especial Pro (NULL = no aplica)',
...
INSERT IGNORE INTO membership_plans (id, name, price, points, descuento, description, is_active, is_featured, display_order) VALUES
(1, 'Proveedor de STREAMING', 50.00, 500, 40.00,
 '40% de descuento en todas las cuentas de tienda|Acceso ilimitado al Marketplace Oficial Proveedor|Alta prioridad para soporte técnico y asistencia|Puedes vender Cuentas de Streaming|Puedes crear comunidades',
 1, 1, 1),
(2, 'Pro', 4.99, 50, 20.00,
 '20% de descuento en todas las cuentas|Soporte VIP directo a tu correo|20% de comisión mensual con tu enlace de referido|Bot de notificación automática por WhatsApp|Insignia verificada',
 1, 0, 2),
(3, 'Curso de Importación', 5.00, 0, 0.00,
 'Acceso al documento de importación|Lista para calcular gastos y ajustar las taras presupuestos|Comunidad de varios emprendedores|Grupo de Telegram para precio importación',
 1, 0, 3);

-- =============================================
-- 5. MEMBRESÍAS DE USUARIOS
-- =============================================
...
('binance_pay',     'Binance Pay',             'Binance Pay | Desde $10 USDT [Automático]',                         10.00, 1000.00, 1, 0,  4),
...
('mercadopago',     'MercadoPago',             '[Automático] YAPE | BCP | PAGO EFECTIVO | Solo Perú',               10.00, 1000.00, 1, 0,  7),
('cryptomus',       'Cryptomus',               'Cryptomus | USDT, BTC, ETH, etc. [Automático] Min $1',              1.00,  1000.00, 1, 0,  8),
('manual',          'Manual Payment',          'Pagos Manuales | Min $10 USD',                                      10.00, 100.00,  1, 0,  9),
('hotmart',         'Hotmart Checkout',        '[Automático] Tarjeta, Transferencias, Pago Efectivo (Mundial)',     10.00, 10.00,   1, 0, 10),
('veripagos',       'Veripagos QR',            'Veripagos QR | Pago con QR Bolivia',                                10.00, 1000.00, 1, 0, 11);

-- =============================================
-- 7. TRANSACCIONES DE RECARGA
-- =============================================
CREATE TABLE IF NOT EXISTS transacciones (
    id                   INT AUTO_INCREMENT PRIMARY KEY,
    usuario_id           INT             NOT NULL,
    movimiento_id        VARCHAR(100)    NOT NULL    COMMENT 'ID externo del proveedor de pago',
    ...
    qr_base64            LONGTEXT                    COMMENT 'QR en base64 (Veripagos)',
...
-- =============================================
-- 9. PRODUCTOS (Licencias / Cursos / Software)
-- =============================================
CREATE TABLE IF NOT EXISTS productos (
    ...
    contenido_entrega  TEXT            NULL    COMMENT 'Clave/link/instrucciones al comprar',
